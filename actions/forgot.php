...
if(isset($_POST['forgot']))
{
    ...
    else
    {
        ...
        $from_name = "SDO-NV Developer";
        $fr_email  = "evan.berong@gmail.com";
        $sub = SUBDIRECTORY;
        ...
        $txt = <<<ELLA
        Good day! We received your request to reset your password at DocuTrack SDONV, please follow the link below to set a new password for your account.
        ...
        For questions, please contact Loyde Soto @ senpailoyde@gmail.com
ELLA;
